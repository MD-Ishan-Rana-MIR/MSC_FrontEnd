...
const ClassicProduct = () => {
    ...
    return (
        <div className="relative w-full h-[300px] sm:h-[400px] lg:h-[500px] overflow-hidden bg-[#23856D]">
            {slides.map((slide, index) => (
                ...
                >
                    <div className="flex flex-col md:flex-row max-w-6xl mx-auto items-center h-full">
                        {/* Left text area */}
                        <div className="w-full md:w-1/2 flex flex-col justify-center px-4 sm:px-6 md:px-10 text-white text-center md:text-left">
                            ...
                            <div className=" flex items-center gap-x-2.5 " >
                                <h3 className=" lg:text-xl text-sm font-bold text-[#FFFFFF] " >$16.48</h3>
                                <Button className="bg-[#2DC071] text-white w-fit mx-auto md:mx-0 px-4 sm:px-6 lg:px-8 py-2 sm:py-3 text-xs sm:text-sm">
                                    ADD TO CART
                                </Button>
                            </div>
                        </div>
            ...
            <button
                onClick={prevSlide}
                className="absolute  cursor-pointer left-2 sm:left-4 top-1/2 transform -translate-y-1/2 bg-white p-2 sm:p-3 rounded-full shadow-md hover:bg-gray-100 z-20"
            >
            ...
            <button
                onClick={nextSlide}
                className="absolute cursor-pointer right-2 sm:right-4 top-1/2 transform -translate-y-1/2 bg-white p-2 sm:p-3 rounded-full shadow-md hover:bg-gray-100 z-20"
            >
            ...
            <div className="absolute bottom-3 sm:bottom-5 left-1/2 transform -translate-x-1/2 flex space-x-2 z-20">
                {slides.map((_, index) => (
                    <span
                        key={index}
                        className={`w-8 sm:w-12 lg:w-16 h-1.5 sm:h-2  ${index === currentIndex ? "bg-white" : "bg-gray-400"
                            }`}
                    />
                ))}
            </div>
