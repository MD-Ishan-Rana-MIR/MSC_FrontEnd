        ...
        <div>
            ...
            >
                <div className="p-4">
                    ...
                    />
                    <h2 className="font-bold lg:text-[16px] text-xs lg:mt-6 mt-3 text-center text-orange-secondary">
                        {item.productName}
                    </h2>
                    <p className="my-2.5 text-orange-light lg:text-sm text-xs text-center font-bold ">{item.categoryName}</p>

                    <div className="flex items-center justify-center gap-3 mt-2">
                        <span className=" text-xs text-[#BDBDBD] lg:text-[16px]  font-bold ]">
                            ৳{item.discountPrice}
                        </span>
                        <span className="text-[16px] font-bold line-through text-orange-primary ">
                            ৳{item.price}
                        </span>
                    </div>
